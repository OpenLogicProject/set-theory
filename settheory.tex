...
\
\\In both schemes, the formulas may contain parameters. Indeed, throughout \olref[sth][][]{part}, we follow the convention that any formula can contain parameters. (See \olref[sfr][infinite][induction]{sec} for a reminder of what it means to say that a formula may contain parameters.)
